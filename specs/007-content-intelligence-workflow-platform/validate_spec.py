...
required = [
    ...
    "data-model-authority-certification.md","plan.md","tasks.md","quickstart.md","runbook.md",
...
if tasks_path.exists():
    ...
    for phase in range(0, 23):
        # Phases are intentionally sparse only if documented; current plan expects 0..22.
...
if trace.exists():
    ...
    for family in ["AUTH","DPC","CJ","ART","QCORR","QRES","QSEC","QAI","QTENANT","QPERF","QDR","QSPEC"]:
...
if quality.exists():
    ...
    for gate in ["QCORRECTNESS","QRESILIENCE","QSECURITY","QSUPPLYCHAIN","QDATA","QPERF","QEVAL","QRECOVERY","QCOMPAT"]:
        if gate not in q:
