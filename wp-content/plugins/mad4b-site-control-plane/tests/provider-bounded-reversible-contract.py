...
req('elementor','elementor/clone-subtree','elementor/move-element','elementor/delete-element','elementor/set-dynamic-tag','mad4b.rollback.elementor-clone-subtree.v1','mad4b.rollback.elementor-move-element.v1','mad4b.rollback.elementor-delete-element.v1','mad4b.rollback.elementor-dynamic-tag.v1')
...
req('elementor',"'etg-filter-title'","'etg-filter-image'","'etg-filter-intro'","'etg-dynamic-content-slot'","'etg-filter-gallery'",'source_copy_only')
