...
def main():
    ...
    require(provider, "'required' => true", "mandatory runtime integrity")
    require(provider, "critical_file_manifest_missing", "missing runtime integrity manifest blocker")
    require(provider, "critical_file_missing", "missing critical runtime file blocker")
    require(provider, "critical_file_hash_mismatch", "critical runtime file hash blocker")
    require(provider, "hash_file( 'sha256'", "runtime critical-file hashing")
