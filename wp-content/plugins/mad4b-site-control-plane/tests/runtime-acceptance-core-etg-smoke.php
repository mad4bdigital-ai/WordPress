...
foreach ( $ability_names as $name ) {
	...
	$check( MAD4B_SCP_Servers::ability_is_mounted( 'mad4b-chatgpt', $name ), 'Acceptance ability is not mounted on mad4b-chatgpt: ' . $name );
	$check( in_array( $name, $chatgpt_tools, true ), 'ChatGPT projection omitted Acceptance ability: ' . $name );
...
$capabilities = wp_get_ability( 'mad4b/acceptance-capabilities' )->execute();
...
$blocked = wp_get_ability( 'mad4b/acceptance-plan' )->execute( array( 'provider_id' => 'etg-dfsb', 'profile_id' => 'tours', 'url' => 'https://example.invalid' ) );
...
$plan = wp_get_ability( 'mad4b/acceptance-plan' )->execute( array( 'provider_id' => 'etg-dfsb', 'profile_id' => 'tours', 'suite' => 'semantic' ) );
...
$run = wp_get_ability( 'mad4b/acceptance-run' )->execute( array( 'provider_id' => 'etg-dfsb', 'profile_id' => 'tours', 'suite' => 'semantic' ) );
...
$canonical = wp_get_ability( 'mad4b/acceptance-result' )->execute( array( 'provider_id' => 'etg-dfsb', 'profile_id' => 'tours', 'suite' => 'semantic' ) );
...
echo "mad4b.site-control-plane.acceptance-core-etg-runtime.v1: PASS\n";
