...
assert "$direct_mutation_transport = array_merge( array( 'mad4b/write-execute', 'mad4b/enrollment-execute' ), $step_up )" in chatgpt_tools
assert "'mad4b/enrollment-execute'" in chatgpt_tools
for low_level in [
