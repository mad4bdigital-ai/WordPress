...
required_server = [
    ...
    "MAD4B_SCP_OAuth_Resource_Bridge::resource_identifiers()",
    ...
    "'authority_gated_write_tool_count'",
    "'provider_gated_catalog_abilities'",
    "'authority_gated_catalog_abilities'",
    "'blocking_conditions'",
    ...
    "authority_gated_runtime_overlap",
    "provider_authority_gate_overlap",
    "Gated catalog abilities",
    "id=\"mad4b-authority-gated-count\"",
    "method:\"POST\"",
    "new URLSearchParams()",
