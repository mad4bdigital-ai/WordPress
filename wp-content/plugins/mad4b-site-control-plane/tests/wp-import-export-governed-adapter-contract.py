...
# Read/plan code must not call provider HTTP/cron execution or expose provider keys.
for forbidden in [
    'wp_remote_get(',
    'wp_remote_post(',
    'wp_remote_request(',
    "'trigger-import','process-import'" + ")," + " 'content'",
    'import_key',
    'export_key',
    'cron_job_key')?->',
]:
...
print('mad4b.wp-import-export-governed-adapter.contract.v2: PASS')
