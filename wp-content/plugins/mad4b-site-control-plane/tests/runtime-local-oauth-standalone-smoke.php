...
if ( ! array_key_exists( 'catalog_write_tool_count', $grant_projection ) || ! array_key_exists( 'runtime_eligible_write_tool_count', $grant_projection ) || ! array_key_exists( 'provider_gated_write_tool_count', $grant_projection ) || ! array_key_exists( 'authority_gated_write_tool_count', $grant_projection ) ) mad4b_local_oauth_fail( 'OAuth live authority tiers are incomplete.', $grant_projection );
if ( (int) $grant_projection['catalog_write_tool_count'] !== (int) $grant_projection['runtime_eligible_write_tool_count'] + (int) $grant_projection['provider_gated_write_tool_count'] + (int) $grant_projection['authority_gated_write_tool_count'] ) mad4b_local_oauth_fail( 'OAuth write catalog partition is not exhaustive.', $grant_projection );
