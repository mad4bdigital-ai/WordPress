...
$check( isset( $status['contract'] ) && 'mad4b.connection-readiness.v1' === $status['contract'], 'Unexpected connection readiness contract.' );
...
$check( count( $status['servers'] ) === 4, 'Expected four MAD4B MCP servers.' );

$expected = array( 'mad4b-read', 'mad4b-content', 'mad4b-admin', 'mad4b-breakglass' );
$seen = array();
...
echo "mad4b.site-control-plane.runtime-connection-readiness.v1: PASS\n";
