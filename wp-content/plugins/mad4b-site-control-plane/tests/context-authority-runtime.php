...
mad4b_context_assert( true === $allowed->invoke( null, $rw . ' ' . MAD4B_SCP_Google_Drive_Context::GMAIL_READ_SCOPE ), 'catalogued Workspace scopes may coexist with the governed Drive scope' );
mad4b_context_assert( false === $allowed->invoke( null, $rw . ' https://www.googleapis.com/auth/youtube.force-ssl' ), 'Google scopes outside the governed Workspace grant catalog must fail closed' );
