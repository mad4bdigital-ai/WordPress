...
if authz.index('MAD4B_SCP_MCP_Peer_Governance::mutation_guard()') > authz.index('MAD4B_SCP_Approval_Tickets::authorize_exact'):
    raise SystemExit('FAIL side-channel-before-approval: peer blocker must run before read-only approval preflight')
