...
require(drive, "Persistent object caches can retain a stale notoptions entry", "stale notoptions persistence false-negative repair")
...
assert "Save Connection Method" not in admin, "auth-mode selection must not expose a manual Save Connection Method button"
