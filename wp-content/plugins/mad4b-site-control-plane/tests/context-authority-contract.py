...
require(oauth_runtime, "mad4b.site-control-plane.context-oauth-lifecycle.runtime.v9: PASS", "Managed, Dedicated, Workspace grants, site-HMAC, and stale-option-cache OAuth lifecycle runtime proof")
...
print("mad4b.site-control-plane.context-authority-contract.v55: PASS")
