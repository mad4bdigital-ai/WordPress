...
final class MAD4B_SCP_Schema {
	...
	const MIGRATION_ID = '20260925-feature007-intent-registry-v11';
	...
	public static function migration_contract() {
		return array(
			...
			'mixed_version_compatibility' => 'additive_v11_schema_preserves_v10_runtime_tables_and_old_code_ignores_new_intent_registry_surface',
	...
	private static function required_durable_columns() {
		return array(
			...
			'intent_relations' => array( 'relation_id', 'site_uuid', 'locale', 'market', 'intent_id', 'content_id', 'role', 'confidence', 'evidence_json', 'source', 'revision', 'valid_from', 'valid_to', 'owner_scope_key', 'relation_sha256', 'created_at' ),
	...
	private static function required_durable_indexes() {
		return array(
			...
			'intent_relations' => array( 'relation_id' => true, 'current_owner_scope' => true, 'scope_content_revision' => true ),
