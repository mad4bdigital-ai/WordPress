			...
			wp_register_ability( self::ABILITY, array(
				...
				'input_schema' => array(
					...
					'properties' => array(
						...
						'expected_source_commit_sha' => array( 'type' => 'string', 'minLength' => 40, 'maxLength' => 40, 'pattern' => '^[A-Fa-f0-9]{40}						'expected_write_tool_count' => array( 'type' => 'integer', 'minimum' => 1, 'maximum' => 200 ),
	...
	public static function reconcile( $input ) {
		...
		try {
			...
			self::$running = false;
						...
						'expected_build_fingerprint' => array( 'type' => 'string', 'minLength' => 64, 'maxLength' => 64, 'pattern' => '^[A-Fa-f0-9]{64}						'expected_write_tool_count' => array( 'type' => 'integer', 'minimum' => 1, 'maximum' => 200 ),
						'expected_write_inventory_fingerprint' => array( 'type' => 'string', 'minLength' => 64, 'maxLength' => 64, 'pattern' => '^[A-Fa-f0-9]{64}$' ),
						'expected_missing_abilities' => array(
							'type' => 'array',
							'minItems' => 0,
	...
	public static function reconcile( $input ) {
		...
		try {
			...
			self::$running = false;
						...
						'expected_package_manifest_digest' => array( 'type' => 'string', 'minLength' => 64, 'maxLength' => 64, 'pattern' => '^[A-Fa-f0-9]{64}						'expected_write_tool_count' => array( 'type' => 'integer', 'minimum' => 1, 'maximum' => 200 ),
						'expected_write_inventory_fingerprint' => array( 'type' => 'string', 'minLength' => 64, 'maxLength' => 64, 'pattern' => '^[A-Fa-f0-9]{64}$' ),
						'expected_missing_abilities' => array(
							'type' => 'array',
							'minItems' => 0,
	...
	public static function reconcile( $input ) {
		...
		try {
			...
			self::$running = false;
						...
						'expected_artifact_identity' => array( 'type' => 'string', 'minLength' => 1, 'maxLength' => 191 ),
						'expected_agent_public_id' => array( 'type' => 'string', 'minLength' => 36, 'maxLength' => 36, 'pattern' => '^[A-Fa-f0-9-]{36}						'expected_write_tool_count' => array( 'type' => 'integer', 'minimum' => 1, 'maximum' => 200 ),
						'expected_write_inventory_fingerprint' => array( 'type' => 'string', 'minLength' => 64, 'maxLength' => 64, 'pattern' => '^[A-Fa-f0-9]{64}$' ),
						'expected_missing_abilities' => array(
							'type' => 'array',
							'minItems' => 0,
