...
final class MAD4B_SCP_Servers {
	...
	public static function write_tools() {
		...
		// AI Agent review remains a stable discovery candidate but only mounts for execution
		// after an administrator explicitly enables the bounded Staging delegation.
	...
	public static function chatgpt_full_catalog_candidates() {
		...
		// Developer and full-authority bootstrap tools are intentionally absent from the
		// normal ChatGPT logical catalog even though they share the enrollment transport.
