	...
	public static function core_tools( $server_id ) {
		...
		$map = array(
			'mad4b-read' => array_merge( array(
				...
				'mad4b/plugin-lifecycle-plan', 'mad4b/workflow-provider-status', 'mad4b/workflow-plan', 'mad4b/runtime-functional-gap-diagnostic', 'mad4b/runtime-functional-gap-diagnostic',
