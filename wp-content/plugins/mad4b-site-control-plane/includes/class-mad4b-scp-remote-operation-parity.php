...
final class MAD4B_SCP_Remote_Operation_Parity {
	...
	private static function browser_acceptance_schema() {
		$properties = self::exact_build_properties();
		$properties['provider_id'] = array( 'type' => 'string', 'minLength' => 1, 'maxLength' => 64, 'pattern' => '^[a-z0-9][a-z0-9._-]{0,63}		return array(
			'type' => 'object',
			'properties' => array(
	...
	private static function work_complete_schema() {
		...
		$properties['job_id'] = array( 'type' => 'string', 'minLength' => 36, 'maxLength' => 36, 'pattern' => '^[A-Fa-f0-9-]{36}$' );
		$properties['executor_id'] = array( 'type' => 'string', 'minLength' => 1, 'maxLength' => 64, 'pattern' => '^[A-Za-z0-9._-]+$' );
		$properties['lease_token'] = array( 'type' => 'string', 'minLength' => 64, 'maxLength' => 64, 'pattern' => '^[A-Fa-f0-9]{64}		return array(
			'type' => 'object',
			'properties' => $properties,
...
MAD4B_SCP_Remote_Operation_Parity::boot();
		...
		$properties['profile_id'] = array( 'type' => 'string', 'minLength' => 1, 'maxLength' => 64, 'pattern' => '^[a-z0-9][a-z0-9._-]{0,63}		return array(
			'type' => 'object',
			'properties' => array(
