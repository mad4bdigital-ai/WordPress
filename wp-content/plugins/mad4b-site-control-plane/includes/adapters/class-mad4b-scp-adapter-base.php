...
abstract class MAD4B_SCP_Adapter_Base {
	...
	public function register_category() {
		wp_register_ability_category( 'mad4b-' . $this->id(), array( 'label' => 'MAD4B ' . $this->label(), 'description' => 'Governed ' . $this->label() . ' integration abilities.' ) );
	}

	public function status() {
		return array( 'id' => $this->id(), 'label' => $this->label(), 'available' => (bool) $this->is_available(), 'abilities' => $this->ability_names(), 'version' => $this->detect_plugin_version() );
	}
