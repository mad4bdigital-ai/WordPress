...
Request-local provider identity revalidation is metadata-only; exact provider content identity remains bounded in the plugin-tree evidence path.
...
Current plugin version: **0.4.0-rc.47**.
