...
Current plugin version: **0.4.0-rc.39**.
...
The isolated runtime CI activates MCP Adapter 0.6.1 and MAD4B Site Control Plane 0.4.0-rc.39 in disposable WordPress/MySQL. Repository success does **not** replace target-site certification.
