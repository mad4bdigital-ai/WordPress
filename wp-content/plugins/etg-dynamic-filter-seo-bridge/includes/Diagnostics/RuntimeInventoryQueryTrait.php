...
trait RuntimeInventoryQueryTrait {
    private function queries(): array {
        ...
        foreach ( $raw as $query ) {
            ...
            $customId = isset( $query->query_id ) && is_scalar( $query->query_id ) ? QueryId::normalize( $query->query_id ) : '';
    ...
    private function queryIdentityKey( string $id, string $customId ): string { return QueryId::normalize( '' !== $customId ? $customId : $id ); }
