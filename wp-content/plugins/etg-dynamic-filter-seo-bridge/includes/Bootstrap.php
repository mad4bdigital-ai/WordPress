...
final class Bootstrap {
    ...
    public function boot():void{
        ...
        $mediaRegistry=new MediaDiscoveryRegistry();$gallery=new GalleryComposer();$content=new ContentComposer($gallery);$scope=new RequestScope($this->config,$profiles);$queryIdentityResolver=new QueryIdentityResolver();$topology=new RuntimeTopologyDiscoverer();$topology->registerInvalidationHooks();$queryBindingResolver=new RuntimeQueryBindingResolver($topology,$queryIdentityResolver);$adapter=new JetEngineResultCountAdapter($queryBindingResolver);$resultCounts=new ResultCountResolver($this->config,$adapter);$languages=new LanguageResolver();
