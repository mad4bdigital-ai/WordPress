...
final class ResultCountResolver {
    ...
    public function resolve( array $context ): array { return $this->resolveInternal( $context, null ); }
    public function resolveFilteredQuery( array $context, array $filteredQuery ): array { return $this->resolveInternal( $context, $filteredQuery ); }

    private function resolveInternal( array $context, ?array $filteredQuery ): array {
        ...
        if ( $this->config->get( 'enable_jet_engine_result_count_adapter', true ) ) {
            $adapted = null === $filteredQuery ? $this->adapter->resolve( $context ) : $this->adapter->resolveFilteredQuery( $context, $filteredQuery );
