...
final class Configuration {
	...
	private function defaultsWithoutFilters(): array {
		return array(
			...
			'allowed_taxonomies' => array( 'location_jet', 'tour-types_jet', 'tour-style_jet' ),
			'max_filters' => 3,
	...
	private function defaultProfilesJson(): string {
		$profiles = array(
			array(
				...
				'allowed_taxonomy_sets' => array( 'location_jet', 'location_jet+tour-types_jet', 'location_jet+tour-types_jet+tour-style_jet' ),
				...
				'taxonomy_rules' => array(
					...
					'tour-style_jet' => array( 'role'=>'style','priority'=>30,'gallery_priority'=>10,'index_single'=>false,'min_results'=>3 ),
				),
				'indexable_combinations' => array(),
