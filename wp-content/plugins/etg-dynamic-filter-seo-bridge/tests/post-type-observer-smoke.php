...
class EtgFakeQuery {
    public $type='posts'; public $postType='property';
    public function __construct($type='posts',$postType='property'){$this->type=$type;$this->postType=$postType;}
...
class EtgFakeManager {
    ...
    public function get_query_by_id($id){return $this->queries[$id]??null;}
}
