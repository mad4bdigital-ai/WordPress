...
$result = $parser->parse( '/it/tours-and-activities/jsf/jet-engine:tours_query_archive/tax/location_jet:cairo;tour-types_jet:day-tours;tour-style_jet:luxury/?utm_source=x&gclid=123' );
...
expect_same( array( 'location_jet' => 'cairo', 'tour-types_jet' => 'day-tours', 'tour-style_jet' => 'luxury' ), $result['filters'], 'filter map' );
...
$pluralStyleDrift = $parser->parse( '/tours-and-activities/jsf/jet-engine:tours_query_archive/tax/tour-styles_jet:archaeology-tours/' );
expect_same( array( 'tour-styles_jet' => 'archaeology-tours' ), $pluralStyleDrift['unknown_filters'], 'taxonomy slug drift remains unprofiled until explicitly configured' );
