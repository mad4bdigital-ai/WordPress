...
$parsed=array('active'=>true,'archive'=>'tours-and-activities','provider'=>'jet-engine','query_id'=>'tours_query_archive','filters'=>array('location_jet'=>'cairo','tour-types_jet'=>'day-tours'));
...
expect_same(true,$combos->evaluate($comboContext)['approved'],'legacy exact pair remains approved after profile migration');
...
expect_same(true,in_array('tour-types_jet',$singleProfile['allowed_taxonomy_sets'],true),'legacy single tour-type opt-in also authorizes the structural single-taxonomy set');
